export const benefit = [
  {
    ...
    description:
      "Tìm kiếm niềm vui với gần nửa triệu điểm tham quan, phòng khách sạn và nhiều trải nghiệm thú vị.",
    image: "/images/benefit/benefit_1.webp",
  },
  {
